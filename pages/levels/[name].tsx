...
const Levels = ({ name }: gameType) => {
  ...
  return (
    <div className="bg-gradient-to-tr from-blue-600 to-teal-500 h-screen font-Quicksand">
      <div className="flex flex-col items-start justify-between h-full w-11/12 mx-auto pt-20 pb-48">
        <button
          onClick={() => router.push('/')}
        ...
        <div className="w-full">
          ...
          <h1 className="text-white text-6xl mb-40">{name}</h1>
          <button className="bg-white rounded-3xl w-full mx-auto py-5 ">
